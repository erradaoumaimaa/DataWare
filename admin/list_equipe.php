...
<table class="table table-dark table-striped custom-table" style="margin-left: -3.3rem; width: 80%;">
    <thead>
        <tr>
            <th style="width: 5%;">ID</th>
            <th style="width: 10%;">Matricule</th>
            <th style="width: 15%;">Nom Prenom</th>
            ...
            <th style="width: 10%;">Nom équipe</th>
